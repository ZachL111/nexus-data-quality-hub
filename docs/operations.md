...
`nexus-data-quality-hub` is centered on data engineering work in C++. The technical target is: Build a C++ toolkit that studies quality behavior through capacity fixtures, with allocation and spill reports and offline replay mode.
...
The score is deterministic. The current threshold is 182. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
