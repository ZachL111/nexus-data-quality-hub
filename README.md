...
nexus-data-quality-hub is a C++ project for data engineering. It focuses on this technical goal: Build a C++ toolkit that studies quality behavior through capacity fixtures, with allocation and spill reports and offline replay mode.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 182, risk penalty 7, latency penalty 3, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
